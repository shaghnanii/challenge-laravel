...
Route::middleware(['auth:api'])->group(function () {
    Route::delete('/remove/{id}', [ConnectionController::class, 'destroy']);
    Route::get("/common", [ConnectionInCommonController::class, 'index']);
    Route::apiResource('/', ConnectionController::class);
});
